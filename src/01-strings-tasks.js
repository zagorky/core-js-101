...
// const w = 6;
// const h = 4;
// console.log(getRectangleString(w, h));
...
// const w = 'Gb trg gb gur bgure fvqr!';
// console.log(encodeToRot13(w));
...
// const w = new String('test');
// console.log(isString(w));
